...
public class PreferenceHostFactory {
	...
	public static void main(String[] args) {
		...
		// host1.setSaveImages(new String[] { "ess-data", "original",
		// "data-canonical-src", "data-src",
		...
		// }
		{
			...
			host1.setSaveImages(new String[]{"src", "ess-data", "original", "data-canonical-src", "data-src", "data-canonical-src", "data-link"});
			FormatterEntry toutiao = new FormatterEntry();
			toutiao.setDate_select(new String[]{"div.article-sub"});
			toutiao.setAuthor_select(new String[]{});
			toutiao.setContent_select(new String[]{"article", "article p"});
		...
		}
		{
			...
			host1.setSaveImages(new String[]{"ess-data", "original", "data-canonical-src", "data-src", "data-canonical-src", "data-link"});
		...
		}
		{
			...
			host2.setSaveImages(new String[]{"ess-data", "original", "data-canonical-src", "data-src", "data-canonical-src", "data-link"});
		...
		}
		{
			...
			host.setSaveImages(new String[]{"ess-data", "original", "data-canonical-src", "data-src", "data-canonical-src", "data-link"});
