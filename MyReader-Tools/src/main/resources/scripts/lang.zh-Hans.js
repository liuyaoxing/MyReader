...
STRINGS.UPLOAD_FAILED = '上传失败，请重新打开读乐乐文件服务并刷新此页重新上传。';
...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到读乐乐的文件';
STRINGS.SUPPORTED_FILE_TYPES = '支持所有文件';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接读乐乐文件服务器，请重新打开读乐乐文件服务并刷新此页后重新上传。';
