...
public class LogHandler {
	...
	private static File getLogFile() {
		...
		try {
			...
			File[] listFiles = f.getCanonicalFile().getParentFile().listFiles(new FileFilter() {
				@Override
	 ...
	 * earlier, the cause exception will not be shown unless the specified throwable
	 * alters printStackTrace.
	 * </p>
	 *
	...
	private static void writeFile(String sb) {
		try {
			...
			FileOutputStream fos = new FileOutputStream(logsFile, true);
