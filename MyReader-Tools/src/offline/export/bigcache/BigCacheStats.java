...
public class BigCacheStats {
	...
	public BigCacheStats(long cacheHit, long cacheMiss, long cacheGet, long cachePut, long cacheDelete,
			long cacheExpire, long cacheMove, long cacheTotalEntries, long storageUsed, long storageDirty,
			long storageCapacity, long storageUsedBlocks, long storageFreeBlocks, long storageTotalBlocks) {
	...
	public BigCacheStats getDeltaStats(BigCacheStats previousStats) {
		...
		return new BigCacheStats(
				...
				this.cacheHit - previousStats.cacheHit, this.cacheMiss - previousStats.cacheMiss,
				this.cacheGet - previousStats.cacheGet, this.cachePut - previousStats.cachePut,
				this.cacheDelete - previousStats.cacheDelete, this.cacheExpire - previousStats.cacheExpire,
				this.cacheMove - previousStats.cacheMove,

				/* $(current value): latest value which is more meaningful */
				this.cacheTotalEntries, this.storageUsed, this.storageDirty, this.storageCapacity,
				this.storageUsedBlocks, this.storageFreeBlocks, this.storageTotalBlocks);
	}
