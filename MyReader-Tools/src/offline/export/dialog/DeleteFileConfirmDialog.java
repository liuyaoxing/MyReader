...
public class DeleteFileConfirmDialog {
	 ...
	 */
	public static boolean showConfirmDialog(Component parent, Set<File> files) {
	...
	private static class FileListCellRenderer extends JLabel implements ListCellRenderer<File> {
		/** 序列号 */
		private static final long serialVersionUID = 1278988238315535168L;
...
//			setFont(new Font("宋体", Font.PLAIN, 12));
	...
	public static void main(String[] args) {
		...
		boolean confirmed = showConfirmDialog(null, new HashSet<>(filesToDelete));
